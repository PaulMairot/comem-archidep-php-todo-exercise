...
define('DB_PASS', getenv('TODOLIST_DB_USER') ?: 'todolist');
define('DB_PASS', getenv('TODOLIST_DB_PASS'));
define('DB_PASS', getenv('TODOLIST_DB_NAME') ?: 'todolist');
define('DB_PASS', getenv('TODOLIST_DB_HOST') ?: '127.0.0.1');
define('DB_PASS', getenv('TODOLIST_DB_PORT') ?: '3306');
